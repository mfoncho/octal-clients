...
const types: { type: "stack" | "queue"; description: string }[] = [
    {
        type: "stack",
        description: "records are added to the top of the collection",
    },
    {
        type: "queue",
        description: "records are added to the bottom of the collection",
    },
];
                ...
                <div className="flex flex-row items-center py-4 justify-between">
                    <div className="flex flex-col pr-8">
                        ...
                        <span className="text-sm text-gray-500">
                            New records can only be created on origin
                            collections
                        </span>
                    </div>
