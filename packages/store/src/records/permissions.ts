...
export const permissions = {
    ...
    ["record.create"]: booleanPermission,
    ["record.move"]: booleanPermission,
    ["record.delete"]: booleanPermission,
    ["catalog.manage"]: booleanPermission,
    ...
    },
    {
        ...
        permissions: [
            ...
            },
            {
                ...
                type: "boolean",
                description:
                    "Create collections, Delete records, move and reorder records and collections",
            },
        ],
    },
    {
